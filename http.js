...
<body>
    <div class="wrapper">
        <div class="home-icon">
            <a href="https://reflect.archf5.com"><img src="/home.png" alt="Home"></a>
        </div>
        <div class="container">
            <h1>${title}</h1>
            <p>${bodyText}</p>
...
function path_rule(r) {
    ...
    if (r.uri === "/hello") {
        ...
        bodyText = "Welcome to the Response Headers Page!";
...
export default { summary, hash, path_rule, generateHtml, redirect, foo };